...
<body>
	...
	<table>
		...
		<c:set var="statuscheck" scope="session" value="pending" />
	...
	<form action="processRequest" method="POST">
		...
		<label>Enter Request Id*:</label> <input type="number" name="id"required /> <br> <br> 
		<label>Comments*:</label> <input type="text" name="comments"required /> <br> <br> 
		<input class="button" type="submit" value="Accept" name="decision" /> 
		<input class="button" type="submit" value="Reject" name="decision" />
		<br> <br>
