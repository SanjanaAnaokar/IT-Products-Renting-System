...
<body>
	...
	<h2>Active Requests - Action required</h2>
	<table>
		<tr>
			<th>Request Id</th>
			<th>Product ID</th>
		...
		<c:set var="statuscheck" scope="session" value="approved"/>
	...
	<form action="returnproduct" method="POST">
		...
		<input class="button" type="submit" value="Return Product" name="decision" /> 
